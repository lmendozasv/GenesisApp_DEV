...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout btn3 = (RelativeLayout) this.findViewById(R.id.fragment_left_menu_login);
        RelativeLayout btn4 = (RelativeLayout) this.findViewById(R.id.btnprofile);
